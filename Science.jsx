...
const Science = () => {
  ...
  const ScienceData = async()=>{
    const url =`
    https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=eb9916a0cb9a47518f801eaa73c91d6b`;
    await axios.get(url).then((response)=>{
      console.log(response.data.articles);
      setScienceData(response.data.articles);
    }).catch((err)=>{
